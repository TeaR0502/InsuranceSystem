...
public class MailUtil {
	 ...
	 */
	    ...
	    public static String myEmailAccount = "t785932260@163.com";
	    public static String myEmailPassword = "zqr123654789";
		...
		public static void senMail(String receiveMailAccount,int code) throws Exception {
	    ...
	    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,int code) throws Exception {
	        ...
	        message.setFrom(new InternetAddress(sendMail, "TeaR", "UTF-8"));
