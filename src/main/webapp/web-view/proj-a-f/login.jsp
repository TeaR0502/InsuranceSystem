...
<body>
	<div class="vbox-0 w350 cen">
		...
		<div id="divlogin">
			<div class="easyui-panel vbox-1" title="用 户 登 录">
				<form action="proja/User/login.do" method="POST" id="fmlogin">
					<div>用户名</div>
		...
		<div id="divreg">
			<div class="easyui-panel vbox-1" title="用 户 注 册">
				<form action="proja/User/reg.do" method="POST" id="fmreg">
					<div>用户名</div>
					<input class="easyui-textbox w300" required="true" name="name" id="name" />
					<div>密码</div>
	...
	<script>
		...
		function sendVerifyCode() {
			$.post("proja/User/sendVerifyCode", {
