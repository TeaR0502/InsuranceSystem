...
<body>
	<div class="easyui-layout" fit="true">
		...
		<div region="north" class="vbox-0 bg-3" border="false">
			...
			<!-- 分页组件 -->
			<div id="mypage" class="easyui-pagination w500" pageSize="9"
		...
		function getlstprd(pageNumber, pageSize, type, name) {
			$.post("Product/listProductF",{
				...
				$.each(res.rows, function(i, n) {
					var row = tmpl_prd.replaceAll("@id", n.productId).replaceAll(
							...
							n.price).replaceAll("@nowprice", n.price*0.8)
							.replaceAll("@period", n.period).replaceAll(
									"@memo", n.memo.substring(0,5));
					$("#lstprd").append(row);
				});
			});
		}
